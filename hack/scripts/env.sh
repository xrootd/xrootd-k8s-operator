...
export XROOTD_OPERATOR_BUNDLE_MANIFEST_DIR="deploy/olm-catalog/${XROOTD_OPERATOR_NAME}"
export XROOTD_OPERATOR_BUNDLE_MANIFEST_VERSION_DIR="${XROOTD_OPERATOR_BUNDLE_MANIFEST_DIR}/${XROOTD_OPERATOR_VERSION}"
